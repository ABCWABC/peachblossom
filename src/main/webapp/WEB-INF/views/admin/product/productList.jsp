												...
												<thead>
													<tr role="row">
														...
														<th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
															aria-sort="ascending"
															aria-label="Rendering engine: activate to sort column descending">상품명</th>
														<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
															aria-label="Browser: activate to sort column ascending">등록일</th>
														<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
															aria-label="Platform(s): activate to sort column ascending">가격</th>
														<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
												...
												<tbody>
													...
													<c:forEach items="${productList }" var="productVO" varStatus="status">
														<tr role="row" class="<c:if test="${status.count % 2 == 0 }">odd</c:if><c:if test="${status.count % 2 != 0 }">even</c:if>">
															...
															<td>
																<a class="move" href="<c:out value="${productVO.pro_num }"></c:out>"><c:out	value="${productVO.pro_name }"></c:out></a>
															</td>
															<td><c:out value="${productVO.pro_name }"></c:out></td>
															...
															<td><input type="checkbox" value='<c:out value="${productVO.pro_buy }"></c:out>' >
																	<c:out value="${productVO.pro_buy == 'Y' ? 'checked': '' }"></c:out>
															</td>
															<td><input type="button" value="수정" data-pro_num='<c:out value="${productVO.pro_num }"></c:out>'></td>
															<td><input type="button" value="삭제" data-pro_num='<c:out value="${productVO.pro_num }"></c:out>'>></td>
														</tr>
													</c:forEach>
