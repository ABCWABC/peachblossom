...
.xans-product-detail .infoArea .xans-product-action .ec-base-button>a,
	.xans-product-detail .infoArea .xans-product-action .ec-base-button>span
	{
	padding: 14px 0;
}
...
.xans-product-additional .shoppingguide {
    margin: 10px auto 10%;
    max-width: 1100px;
    background: #fff;
